...
function About() {
  ...
  useSEO({
    title: "About Vsachi Tech | Software Development Company in India",
    description:
      "Learn about Vsachi Tech, a trusted software development company delivering scalable systems, automation, and modern digital solutions.",
    canonical: "https://vsachitech.com/who-we-are",
  });
  ...
  return (
    <div className="bg-white">
      <h1 className="sr-only">About Vsachi Tech</h1>
      {/* Hero Section */}
      <section
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6 px-5">
              <p className="text-gray-900 text-xl font-semibold">
                We are a technology partner focused on building reliable
                software systems from modern websites to backend platforms,
                APIs, and automation solutions.
              </p>

              <p className="text-gray-700 leading-relaxed">
                At Vsachi Tech, we combine clean engineering, thoughtful design,
                and modern technologies to create software that performs in real
                world conditions. Every solution is built with clarity,
                performance, and long term scalability in mind.
              </p>

              <p className="text-gray-700 leading-relaxed">
                We don’t just deliver projects we build systems that support
                growth. From technical architecture to execution, we help
                businesses make informed decisions and turn ideas into
        ...
        <div className="marquee-container">
          <div className="marquee-content">
            <span className="marquee-text">
              SOFTWARE SYSTEMS • AUTOMATION • APIs • SCALABLE ARCHITECTURE
            </span>
            <span className="marquee-text">
              SOFTWARE SYSTEMS • AUTOMATION • APIs • SCALABLE ARCHITECTURE
            </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3">
            {[
              {
                title: "Expertise",
                text: "Our team comprises highly skilled professionals with extensive experience creating visually appealing and user-friendly websites.",
                icon: <FiLayers />,
              },
              {
                title: "Solutions",
                text: "We understand that each business is unique. We offer customized web design services to match your brand identity and business goals perfectly.",
                icon: <FiTriangle />,
              },
              {
                title: "Experience",
                text: "Our experienced design and development teams ensure your website delivers seamless navigation and an engaging visitor experience.",
                icon: <FiStar />,
              },
              {
                title: "Strategy",
                text: "We develop a long-term strategic plan that outlines how to create and establish your company’s online presence.",
                icon: <FiTarget />,
              },
              {
                title: "Consultation",
                text: "Gain a competitive edge with expert advice and insights. Our consulting services help you make informed decisions and achieve success.",
                icon: <FiHexagon />,
              },
              {
                title: "Support",
                text: "We troubleshoot technical issues and provide user support to ensure your site always meets your needs.",
                icon: <FiPlus />,
              },
            ].map((item, i) => {
            ...
            `}
                >
                  ...
                  {/* TITLE */}
                  <h3 className="text-[22px] font-bold mb-6">{item.title}</h3>
      ...
      <section className="bg-[#f4f4f4] py-28">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20">
          ...
          <div className="space-y-6 text-gray-700">
            <p className="text-lg">
              Build software that works reliably, scales efficiently, and
              supports your{" "}
              <span className="text-red-600">business goals.</span>
            </p>

            <p>
              At Vsachi Tech, we focus on engineering quality, clean
              architecture, and practical solutions not shortcuts.
            </p>

            <p>
              We work with startups, growing businesses, and teams that value
              performance and long-term stability.
            </p>

            <p>
              Our team brings deep experience across web, backend, Python, APIs,
              and automation.
            </p>

            <p className="font-bold text-red-600">
              You work directly with experienced engineers. No fluff. No
              shortcuts.
            </p>
          </div>
        </div>
