...
function Services() {
  ...
  const [activeStrengthIndex, setActiveStrengthIndex] = React.useState(null);
  return (
...
<section><ImageText withBackground={true} /></section>
  ...
  },
  {
    ...
    desc: "Enterprise-grade automation designed with security, scalability, and performance as core principles.",
      ...
      <section className="relative text-white pb-20 pt-5 px-5 overflow-hidden">
      ...
      <section className="relative bg-[#f4f3f1] text-[#1c1c1c] px-8 py-24 overflow-hidden">
        {/* CUSTOM CURSOR - purely visual, no pointer events */}
        {cursor.show && (
          <div
