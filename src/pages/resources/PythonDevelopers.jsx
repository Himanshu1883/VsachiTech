import { FaPython, FaCheckCircle, FaRocket, FaCode, FaUsers, FaClock, FaShieldAlt, FaDollarSign } from "react-icons/fa";
    ...
    return (
        <section className="bg-white text-black overflow-hidden">
            ...
            <section className="relative min-h-[90vh] flex items-center">
                {/* FLOATING PYTHON ICONS BACKGROUND */}
                ...
                <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10 pt-32 pb-20">
                    ...
                    <div>
                        <h1 className="text-5xl font-bold leading-tight mb-6">
                            Hire Industry Ready{" "}
                            <span className="text-[#e44f39]">Python Developers</span>
                        </h1>

                        <p className="text-gray-600 text-lg max-w-xl mb-10">
                            Build scalable, secure, and high-performance applications with
                            experienced Python engineers skilled in Django, FastAPI, and Flask.
                        </p>
               ...
               bg-no-repeat bg-center bg-fit opacity-100"
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <h2 className="text-center text-3xl md:text-4xl font-bold mb-10 max-w-4xl mx-auto leading-tight">
                        Build Powerful, Scalable Python Solutions With
                        <span className="text-[#e44f39]"> Industry Ready Developers</span>
                    </h2>
            ...
            {/* ================= PYTHON TECH STACK MARQUEE SECTION ================= */}
            <PythonMarqueeSection />
            ...
            {/* ================= PYTHON USE CASES SECTION ================= */}
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            What Can You Build with <span className="text-[#e44f39]">Python?</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            From web applications to AI solutions, Python powers diverse projects across industries
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Scalable web apps with Django, Flask, and FastAPI for high performance",
                                icon: "🌐",
                                color: "from-blue-500 to-blue-600"
                            },
                            {
                                title: "Data Analytics",
                                desc: "Process and visualize data with Pandas, NumPy, and Matplotlib",
                                icon: "📊",
                                color: "from-green-500 to-green-600"
                            },
                            {
                                title: "Machine Learning",
                                desc: "Build AI models with TensorFlow, PyTorch, and Scikit-learn",
                                icon: "🤖",
                            ...
                            },
                            {
                                ...
                                desc: "Automate workflows, data processing, and testing",
                                icon: "⚙️",
                                color: "from-red-500 to-red-600"
                            },
                            {
                                title: "IoT Solutions",
                                desc: "Connect and manage IoT devices with Python backends",
                                icon: "📡",
            ...
            <section className="py-24 bg-gradient-to-br from-gray-50 to-gray-100">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Get your Python development team up and running in no time
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 relative">
                        ...
                        {[
                            ...
                            },
                            {
                                ...
                                desc: "Get pre-vetted Python developer profiles within 24 hours",
                                icon: FaUsers
                            },
                            {
                                step: "03",
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            Our Python Developers' <span className="text-[#e44f39]">Skill Set</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Comprehensive expertise across the Python ecosystem
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border-2 border-gray-100">
                            ...
                            <div className="space-y-4">
                                {[
                                    { skill: "Django Framework", level: 95 },
                                    { skill: "FastAPI & Modern APIs", level: 90 },
                                    { skill: "Flask Microservices", level: 88 },
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border-2 border-gray-100">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-2xl font-bold">Data Science & ML</h3>
                            </div>
                            <div className="space-y-4">
                                {[
                                    { skill: "Machine Learning Models", level: 87 },
                                    { skill: "Data Analysis & Pandas", level: 93 },
                                    { skill: "TensorFlow & PyTorch", level: 85 },
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border-2 border-gray-100">
                            ...
                            <div className="space-y-4">
                                {[
                                    { skill: "PostgreSQL & SQL", level: 91 },
                                    { skill: "MongoDB & NoSQL", level: 88 },
                                    { skill: "Redis Caching", level: 86 },
                                    { skill: "Database Optimization", level: 89 }
                                ].map((item, idx) => (
                                    <div key={idx}>
                                        <div className="flex justify-between mb-2">
                                            <span className="font-medium">{item.skill}</span>
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border-2 border-gray-100">
                            ...
                            <div className="space-y-4">
                                {[
                                    { skill: "AWS Cloud Services", level: 89 },
                                    { skill: "Docker Containerization", level: 92 },
                                    { skill: "CI/CD Pipelines", level: 87 },
                                    { skill: "Kubernetes Orchestration", level: 84 }
                                ].map((item, idx) => (
                                    <div key={idx}>
                                        <div className="flex justify-between mb-2">
                                            <span className="font-medium">{item.skill}</span>
                                            <span className="text-orange-600 font-semibold">{item.level}%</span>
                                        </div>
                                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                            <div 
                                                className="h-full bg-gradient-to-r from-orange-500 to-orange-700 rounded-full transition-all duration-1000"
                                                style={{ width: `${item.level}%` }}
                                            />
                                        </div>
                                    </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            {
                                number: "20+",
                                label: "Python Projects Delivered",
                                icon: FaRocket,
                                color: "from-blue-500 to-blue-600"
                            },
                            {
                                number: "30+",
                                label: "Expert Python Developers",
                                icon: FaUsers,
                                color: "from-green-500 to-green-600"
                            },
                            {
                        ...
                        {[
                            {
                                ...
                                desc: "Pre-vetted developers ready to contribute from day one."
                            },
                            {
                                title: "Flexible Engagement Models",
                                desc: "Hire full-time, part-time, or dedicated Python resources."
                            },
                            {
                            ...
                            >
                                <FaPython className="text-3xl text-[#e44f39] mb-5" />
            ...
            <section className="py-24 bg-gradient-to-br from-[#e44f39] to-red-600 text-white">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl mb-10 max-w-2xl mx-auto opacity-90">
                        Get access to pre-vetted Python developers and start your project within 48 hours
                    </p>
...
// ================= PYTHON MARQUEE SECTION COMPONENT =================
function PythonMarqueeSection() {
    const technologies = [
        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
            <div className="container mx-auto px-6 mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
                    Complete <span className="text-[#e44f39]">Python Tech Stack</span>
                </h2>
                <p className="text-gray-600 text-center max-w-2xl mx-auto">
                    Our developers are proficient in the entire Python ecosystem
                </p>
            </div>
