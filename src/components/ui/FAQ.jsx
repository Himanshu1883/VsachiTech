...
const FAQ = () => {
    ...
    const faqItems = [
        ...
        {
            question: "What is your experience in Indian & UAE markets?",
            answer: "We bring 8+ years of deep-rooted expertise in the Indian enterprise landscape, combined with our strategic expansion into the UAE market since 2025. This dual market experience enables us to deliver solutions that blend proven methodologies with region specific innovations."
        }
    ];
                        ...
                        {faqItems.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        className={`w-8 h-8 flex items-center justify-center rounded-full border transition ${openIndex === index
