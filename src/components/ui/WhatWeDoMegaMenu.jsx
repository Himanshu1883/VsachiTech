...
export default function WhatWeDoMegaMenu({ open, onEnter, onLeave }) {
    return (
        <div
            ...
            className={`
        fixed top-[94px] left-1/2 -translate-x-1/2 w-[80%] h-[45vh] z-40
        bg-[#121212]/90 backdrop-blur-xl rounded-3xl
        border border-white/10 shadow-2xl
        transition-all duration-300 ease-out overflow-hidden
        ${open ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-4"}
      `}
        >
            <div className="h-full w-full px-10 lg:px-14 py-8 flex items-center">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 w-full h-full">

                    {/* SERVICES */}
                    <div className="lg:col-span-7 flex flex-col">
                        <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[#e44f39] mb-4">
                            Our Services
                        </h3>
                    ...
                    <div className="hidden lg:flex lg:col-span-1 items-center justify-center">
                        <div className="h-[85%] w-px bg-white/10" />
                    </div>
                            ...
                            {hiringResources.map((resource) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            className="
                        flex items-center gap-4 p-3.5 rounded-xl
                        bg-white/5 border border-white/10
                        transition-all duration-300
                        hover:bg-white/10 hover:border-[#e44f39]/40 mb-2
                      "
                                        >
